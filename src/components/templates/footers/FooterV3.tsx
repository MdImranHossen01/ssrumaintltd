               ...
               <div className="space-y-8">
                  ...
                  <div className="space-y-4">
                     <div className="flex items-center gap-4 text-xs text-neutral-400">
                        <Mail className="h-4 w-4 text-primary" /> {settings?.contact?.email || process.env.NEXT_PUBLIC_SUPPORT_EMAIL || ''}
                     </div>
                     <div className="flex items-center gap-4 text-xs text-neutral-400">
                        <Phone className="h-4 w-4 text-primary" /> {settings?.contact?.phone || process.env.NEXT_PUBLIC_SUPPORT_PHONE || ''}
                     </div>
                     <div className="flex items-center gap-4 text-xs text-neutral-400">
                        <MapPin className="h-4 w-4 text-primary" /> {settings?.contact?.address || ''}
                     </div>
                  </div>
               </div>
