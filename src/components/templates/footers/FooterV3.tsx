            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-24">
               ...
               <div className="space-y-8">
                  <div className="flex items-center gap-3 text-primary">
                     ...
                     <span className="font-black text-sm sm:text-base md:text-xl tracking-tighter break-words max-w-[200px] md:max-w-none">SS Ruma International Ltd</span>
                  </div>
               ...
               <div className="space-y-8">
                  ...
                  <div className="space-y-4">
                     <div className="flex items-center gap-4 text-xs text-neutral-400">
                        <Mail className="h-4 w-4 text-primary" /> {settings?.contact?.email || 'support@SSRumaInternationalLtd.com'}
                     </div>
                     <div className="flex items-center gap-4 text-xs text-neutral-400">
