  ...
  try {
    ...
    if (!settings) {
      return NextResponse.json({
        brandName: process.env.NEXT_PUBLIC_STORE_NAME || "SS Ruma International Ltd",
        contact: {
        ...
        marqueeText: "Welcome to SS Ruma International Ltd!",
        metaTitle: process.env.NEXT_PUBLIC_STORE_NAME || "SS Ruma International Ltd",
