...
export const metadata: Metadata = {
  title: 'About Us | SS Ruma International Ltd',
  description: 'SS Ruma International Ltd - Premium menswear brand in Bangladesh. Explore our high-quality collection of T-shirts, Polo Shirts, Casual & Formal Shirts, and Hoodies designed for modern comfort.',
};
...
async function getSettings() {
  try {
    ...
    if (!settings) {
      return {
        brandName: "SS Ruma International Ltd",
        contact: {
          email: "support@SSRumaInternationalLtd.com",
          phone: "+8801234567890",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-muted-foreground text-sm md:text-base leading-relaxed">
                At SS Ruma International Ltd, we believe that style and comfort should go hand in hand. We curate each piece of apparel—whether it is an everyday t-shirt, a smart polo, a classic shirt, or a cozy hoodie—using top-grade fabric blends that ensure durability, breathability, and a premium feel.
              </p>
              <p className="text-muted-foreground text-sm md:text-base leading-relaxed">
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-background p-8 rounded-2xl border shadow-sm space-y-4 text-center flex flex-col items-center hover:-translate-y-1 transition-all duration-300">
              ...
              <p className="text-muted-foreground text-xs leading-relaxed max-w-[280px]">
                Thousands of satisfied fashion-conscious clients across Bangladesh trust SS Ruma International Ltd for their daily wear.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 text-center relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10 space-y-6">
          <h2 className="text-3xl md:text-5xl font-black tracking-tight max-w-2xl mx-auto leading-tight">
            Upgrade Your Wardrobe with SS Ruma International Ltd Essentials
          </h2>
