...
export const metadata: Metadata = {
  title: 'Privacy Policy | SS Ruma International Ltd',
  description: 'Learn how SS Ruma International Ltd collects, uses, and protects your personal information.',
};
...
export default async function PrivacyPage() {
  ...
  const contactEmail = settings.contact?.email || "support@SSRumaInternationalLtd.com";
